...
<nav class="space-y-2">
<a class="flex items-center gap-3 px-4 py-3 rounded-xl {{ ($active ?? '') === 'groups' ? 'bg-[#e8f3f3] text-koopa-teal font-semibold' : 'text-koopa-muted hover:bg-koopa-surface' }}" href="/groups">
<span class="material-symbols-outlined">group</span>
My Groups
</a>
<a class="flex items-center gap-3 px-4 py-3 rounded-xl {{ ($active ?? '') === 'members' ? 'bg-[#e8f3f3] text-koopa-teal font-semibold' : 'text-koopa-muted hover:bg-koopa-surface' }}" href="/group-members">
<span class="material-symbols-outlined">group_add</span>
Members
</a>
<a class="flex items-center gap-3 px-4 py-3 rounded-xl {{ ($active ?? '') === 'marketplace' ? 'bg-[#e8f3f3] text-koopa-teal font-semibold' : 'text-koopa-muted hover:bg-koopa-surface' }}" href="/marketplace">
...
<a class="flex items-center gap-3 px-4 py-3 rounded-xl {{ ($active ?? '') === 'drop-points' ? 'bg-[#e8f3f3] text-koopa-teal font-semibold' : 'text-koopa-muted hover:bg-koopa-surface' }}" href="/drop-points">
<span class="material-symbols-outlined">local_shipping</span>
Drop Points
</a>
<a class="flex items-center gap-3 px-4 py-3 rounded-xl {{ ($active ?? '') === 'orders' ? 'bg-[#e8f3f3] text-koopa-teal font-semibold' : 'text-koopa-muted hover:bg-koopa-surface' }}" href="/orders">
<span class="material-symbols-outlined">shopping_bag</span>
Orders
</a>
<a class="flex items-center gap-3 px-4 py-3 rounded-xl {{ ($active ?? '') === 'invoices' ? 'bg-[#e8f3f3] text-koopa-teal font-semibold' : 'text-koopa-muted hover:bg-koopa-surface' }}" href="/invoices">
<span class="material-symbols-outlined">receipt_long</span>
Invoices
</a>
<a class="flex items-center gap-3 px-4 py-3 rounded-xl {{ ($active ?? '') === 'escrow' ? 'bg-[#e8f3f3] text-koopa-teal font-semibold' : 'text-koopa-muted hover:bg-koopa-surface' }}" href="/escrow-payments">
...
<p class="text-sm font-semibold">{{ $authUser?->display_name ?? $authUser?->name ?? 'UMKM User' }}</p>
...
{{ strtoupper(substr($authUser?->display_name ?? $authUser?->name ?? 'U', 0, 2)) }}
</div>
@endif
